...
export const DE: JigsawStrings = {
  ...
  moves: 'Gelegt', left: (n: number) => `noch ${n} Teile`, edgeOnly: 'Nur Randteile', hint: 'Bild schwach einblenden', original: 'Ganzes Bild ansehen', trayHint: 'Zieh Teile aus der Ablage nach oben an ihren Platz. Zum Zoomen aufziehen, mit zwei Fingern verschieben',
