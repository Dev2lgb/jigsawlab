...
export const DE: JigsawStrings = {
  ...
  time: 'Zeit', moves: 'Gelegt', left: (n: number) => `noch ${n} Teile`, edgeOnly: 'Nur Randteile', hint: 'Bild schwach einblenden', zoomIn: 'Heranzoomen', zoomOut: 'Herauszoomen', fit: 'Einpassen', trayHint: 'Zieh Teile aus der Ablage nach oben an ihren Platz. Zum Zoomen aufziehen, mit zwei Fingern verschieben',
