...
export const DE: JigsawStrings = {
  ...
  done: 'Fertig!', resTime: 'Zeit', resPieces: 'Teile', resMoves: 'Züge', best: (s: string) => `Deine Bestzeit: ${s}`, newBest: 'Neuer Rekord!', roomDone: 'Schon fertiggestellt', roomDoneSub: (n: number) => `Deine Freunde haben alle ${n} Teile gelegt`, roomDoneMine: 'Selbst probieren', retry: 'Dasselbe Foto noch einmal', another: 'Anderes Puzzle', toTitle: 'Zurück zum Anfang',
