...
export const EN: JigsawStrings = {
  ...
  seoTitle: (n: number) => `Free online jigsaw puzzles — ${n} to choose from`, boardTitle: 'Puzzle board', seoDesc: (n: number) => `Play free jigsaw puzzles online, no sign-up. ${n} paintings, Korean art and space photos — or your own picture. 48 to 1000 pieces. Solve with a friend from one link.`,
  ...
  done: 'Complete!', resTime: 'Time', resPieces: 'Pieces', resMoves: 'Placements', best: (s: string) => `Your best: ${s}`, newBest: 'New record!', roomDone: 'Already finished', roomDoneSub: (n: number) => `Your friends put all ${n} pieces together`, roomDoneMine: 'Try it myself', retry: 'Same photo again', another: 'Another puzzle', toTitle: 'Back to start',
