...
export const EN: JigsawStrings = {
  ...
  moves: 'Placed', left: (n: number) => `${n} pieces left`, edgeOnly: 'Edge pieces only', hint: 'Ghost image', original: 'View the full picture', trayHint: 'Drag pieces up from the tray into place. Pinch to zoom, two fingers to pan',
