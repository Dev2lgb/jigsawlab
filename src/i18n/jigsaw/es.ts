...
export const ES: JigsawStrings = {
  ...
  done: '¡Completo!', resTime: 'Tiempo', resPieces: 'Piezas', resMoves: 'Colocaciones', best: (s: string) => `Tu mejor marca: ${s}`, newBest: '¡Récord nuevo!', roomDone: 'Ya está terminado', roomDoneSub: (n: number) => `Tus amigos colocaron las ${n} piezas`, roomDoneMine: 'Probarlo yo mismo', retry: 'La misma foto otra vez', another: 'Otro rompecabezas', toTitle: 'Volver al inicio',
  ...
  tools: 'Herramientas de la bandeja', find: 'Buscar piezas', findNone: 'No hay piezas sueltas en el tablero',
