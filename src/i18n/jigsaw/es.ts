...
export const ES: JigsawStrings = {
  ...
  time: 'Tiempo', moves: 'Colocadas', left: (n: number) => `quedan ${n} piezas`, edgeOnly: 'Solo los bordes', hint: 'Imagen de fondo', zoomIn: 'Acercar', zoomOut: 'Alejar', fit: 'Ajustar', trayHint: 'Arrastra las piezas de la bandeja hacia arriba hasta su sitio. Pellizca para acercar, dos dedos para desplazar',
