...
export const JA: JigsawStrings = {
  ...
  seoTitle: (n: number) => `無料オンラインジグソーパズル${n}点`, boardTitle: 'パズルを組む', seoDesc: (n: number) => `登録なしですぐ遊べる無料ジグソーパズル。名画・韓国絵画・宇宙写真${n}点と自分の写真で、48ピースから1000ピースまで。リンク一つで友だちと一緒に。`,
  ...
  done: '完成！', resTime: 'タイム', resPieces: 'ピース', resMoves: '置いた回数', best: (s: string) => `自己ベスト ${s}`, newBest: '新記録！', roomDone: 'すでに完成しています', roomDoneSub: (n: number) => `友だちが${n}ピースを組み上げました`, roomDoneMine: '自分でもやってみる', retry: '同じ写真でもう一度', another: '別のパズル', toTitle: 'はじめに戻る',
