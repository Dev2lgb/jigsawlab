...
export const KO = {
  ...
  // title/sub 는 화면에 보이는 문구, seoTitle/seoDesc 는 <title>·description 전용 — 작품 수는 손으로 적지 말고 인자로 받는다(423·518 로 박혀 있다가 어긋났다)
  seoTitle: (n: number) => `무료 온라인 직소퍼즐 ${n}점 맞추기`, boardTitle: '퍼즐 맞추는 중', seoDesc: (n: number) => `가입 없이 바로 시작하는 무료 직소 퍼즐. 명화·한국 회화·우주 사진 ${n}점과 내 사진으로, 48조각부터 1000조각까지. 링크 하나로 친구랑 같이 맞춰요.`,
