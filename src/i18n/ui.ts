...
export const UI = {
  ko: {
    ...
    nav: { daily: '오늘의 퍼즐', catalog: '퍼즐', together: '모두의 퍼즐', photo: '내 사진으로', play: '지금 맞추기', about: '소개', my: '내 퍼즐' },
...
<p>퍼즐 상세 페이지에서 <b>친구랑 같이</b>를 누르면 우리끼리만 들어가는 방이 따로 만들어집니다. 그림도 조각 수도 직접 고르고, 링크를 받은 사람만 들어옵니다.</p>`,
  ...
  en: {
    ...
    nav: { daily: "Today's puzzle", catalog: 'Puzzles', together: 'Open board', photo: 'Your photo', play: 'Play now', about: 'About', my: 'My puzzles' },
...
<p>On any puzzle page, <b>Play with friends</b> creates a private room of your own — your picture, your piece count, and only the people you send the link to.</p>`,
  ...
  ja: {
    ...
    nav: { daily: '今日のパズル', catalog: 'パズル', together: 'みんなのパズル', photo: '自分の写真で', play: '今すぐ遊ぶ', about: 'サイトについて', my: 'マイパズル' },
