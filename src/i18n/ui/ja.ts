...
export const JA: UIStrings = {
  ...
  lv: {
    ...
    rulesTitle: 'XPの貯まりかた',
    rules: ['ピースを1つはめると1 XP。1000ピースを1枚仕上げれば1000 XP', '今日のパズルは1.5倍', '同じ絵を同じ規模で解き直すと4分の1', '部屋では自分がはめたピースの分だけ', '1日にもらえるXPは5,000まで', '時間と手数は見ません — 速い人ではなく、たくさん解いた人が上に行きます', '1日・1週間の区切りは韓国時間（KST、日本時間と同じ）。週間ランキングは月曜0時に切り替わります'],
    ...
    earn: (n: string) => `仕上げると +${n} XP`, earnRepeat: (n: string) => `仕上げると +${n} XP・クリア済みの絵なので1/4`, earnDaily: (n: string) => `仕上げると +${n} XP · 今日のパズルは1.5倍`, earnLive: '自分がはめたピース1つにつき 1 XP',
  },
  guide: 'ガイド',
