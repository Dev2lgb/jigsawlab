...
export const JA: UIStrings = {
  ...
  lv: {
    ...
    platesTitle: 'ネームタグ', platesLead: 'レベルが上がるとニックネームのプレートが変わります。ランキング・みんなのパズル・友だちの部屋、どこでもこのプレートで表示され、ピースを置いたときに舞い上がるほこりもプレートの色になります', plateNames: ['厚紙', '銅', '銀', '金', 'クリスタル', 'パール'], plateSample: 'パズラー', plateMine: 'いまのプレート',
