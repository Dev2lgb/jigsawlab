...
export const KO = {
  ...
  lv: {
    ...
    rules: ['조각 하나를 제자리에 놓으면 1 XP. 1000조각 판을 끝내면 1000 XP', '오늘의 퍼즐은 1.5배', '이미 그만큼 깨 본 그림을 다시 맞추면 4분의 1', '방에서는 내가 놓은 조각만큼', '하루에 받는 XP 는 5,000 까지', '시간과 수순은 안 봐요 — 빨리 푼 사람이 아니라 많이 맞춘 사람이 위로 갑니다', '하루와 한 주는 한국 시간(KST) 기준이에요. 주간 랭킹은 월요일 0시에 새로 시작해요'],
    ...
    earn: (n: string) => `다 맞추면 +${n} XP`, earnRepeat: (n: string) => `다 맞추면 +${n} XP · 이미 깬 그림이라 ¼`, earnDaily: (n: string) => `다 맞추면 +${n} XP · 오늘의 퍼즐은 1.5배`, earnLive: '내가 놓은 조각 하나에 1 XP',
  },
  guide: '가이드',
