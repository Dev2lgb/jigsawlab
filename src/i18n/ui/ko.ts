...
export const KO = {
  ...
  my: { title: '내 퍼즐', inProgress: '하던 퍼즐', done: '완성한 퍼즐', favs: '즐겨찾기', emptyProgress: '하던 퍼즐이 없어요', emptyDone: '아직 완성한 퍼즐이 없어요', emptyFavs: '퍼즐의 하트를 누르면 여기 모여요', resume: '이어하기', del: '지우기', pieces: (n: number) => `${n}조각`, photo: '내 사진', doneCount: (n: number) => `${n}판`, stats: '통계', statTime: '총 시간', statPpm: '분당 조각', statBiggest: '가장 큰 판', statDaily: '오늘의 퍼즐', byShelf: '진열대별 진도', calendar: '완성한 날', calN: (n: number) => `${n}판`, hm: (h: number, m: number) => (h ? `${h}시간 ${m}분` : `${m}분`), emptyStats: '한 판 맞추면 통계가 쌓여요', view: '완성 보기', replay: '맞춘 순서로 다시 보기', again: '다시 맞추기', onDevice: '이 기기에만 저장돼요' },
  lv: {
