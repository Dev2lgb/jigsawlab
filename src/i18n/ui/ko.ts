...
export const KO = {
  ...
  app: { install: '앱 설치', installTitle: '앱으로 설치', iosLead: 'Safari 아래쪽의 공유 버튼을 누르고 "홈 화면에 추가"를 고르면 홈 화면에서 앱처럼 열려요', iosStep1: '공유 버튼', iosStep2: '홈 화면에 추가', otherLead: '이 브라우저는 바로 설치를 지원하지 않아요. Chrome·Edge 나 iPhone 의 Safari 에서 열면 홈 화면에 앱으로 추가할 수 있어요' },
