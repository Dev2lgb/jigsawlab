...
export const PLATE_DUST: { tones: string[]; grains: string[]; cloud: number; grain: number; tw: number }[] = [
  ...
  // 흑요석 — 검은 연기와 금빛 안개가 섞이고 금가루가 반짝인다. 연기만이면 밝은 판에서 그을음처럼 보여서 안개 셋 중 하나를 짙은 금으로
  { tones: ['70,62,76', '188,138,44', '96,86,98'], grains: ['255,210,100', '255,236,170', '196,134,20', '255,255,255'], cloud: 1.9, grain: 4.4, tw: 24 },
];
